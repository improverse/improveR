...
Resources in improve can be **finished** (locked) to prevent further modifications. This is used to protect validated work from accidental changes. Finishing a folder locks all its contents.
