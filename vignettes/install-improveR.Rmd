...
cat("Current repositories:\n")
print(current_repos)

# Add improve repository
improve_repo <- c(improve = "https://scinteco-improver.s3.amazonaws.com/main/")
new_repos <- c(current_repos, improve_repo)

# Set the new repository configuration
...
install.packages("improveR", repos = "https://scinteco-improver.s3.amazonaws.com/main/")
#this package contains the CLI tools
install.packages("improveRcontributions", repos = "https://scinteco-improver.s3.amazonaws.com/main/")
