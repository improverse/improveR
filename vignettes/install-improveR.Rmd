...
If you prefer to use Docker the code below returns a Docker image which provides a reproducible, self-contained environment with R 4.4.0 and the improveR packages ready to use.
