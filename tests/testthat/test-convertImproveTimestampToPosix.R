test_that("Does convertImproveTimestampToPosix convert a timestamp to a POSIXct object?", {
  ...
  time_res <- c("2025-01-08 09:28:58.243", "2025-01-08 13:29:32.152", "1970-01-01 01:00:00")

  expect_equal(convertImproveTimestampToPosix(timestamps) %>% as.character, time_res)
