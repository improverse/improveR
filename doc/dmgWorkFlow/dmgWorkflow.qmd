...
The obtained dataframe `workflowUnnested` contains all steps of the workflow, with their `remoteFiles` expanded into multiple columns.
...
For an inductive approach, let's take one element of the `remoteFilesVersionLinks` dataframe and check its properties.
